...
import com.pmandcode.schedule.ScheduleSpeechlet;

/**
 * Shared launcher for executing sample skills within a single servlet container.
 */
public final class Launcher {
	...
	public static void main(final String[] args) throws Exception {
		...
		//TODO remove before going into production, this for local tests only!
		...
		sslContextFactory.setKeyStorePath("src/main/resources/sslkey/mykeystore.jks");
		...
		context.addServlet(new ServletHolder(createServlet(new ScheduleSpeechlet())), "/schedule");
		server.start();
		server.join();
	}
